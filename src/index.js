...
const app = (function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        for (let i = 65; i <= 90; i++) {
            ...
            alphabetContent === null || alphabetContent === void 0 ? void 0 : alphabetContent.appendChild(btn);
        }
    });
    // Employee class creation
    class Employee {
        constructor(empNo, firstName, lastName, dob, email, mobileNumber, joinDate, location, role, department, manager, project, status = "Active", profileImg) {
            this.empNo = empNo;
    ...
    function addEmployee() {
        ...
        const employee = new Employee(empNo, firstName, lastName, dob, email, mobileNumber, joinDate, location, role, department, manager, project, status, profileImg);
    ...
    function deleteCheckedRows() {
        ...
        box.forEach(checkbox => {
            ...
            const empidSelector = tabrow.querySelector('#empId');
    ...
    (_a = document.getElementById('addEmpBtn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', (e) => {
        e.preventDefault();
        addEmployee();
    });
    (_b = document.getElementById('tBody')) === null || _b === void 0 ? void 0 : _b.addEventListener('change', function (event) {
